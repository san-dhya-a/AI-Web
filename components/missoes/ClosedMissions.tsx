            ...
            <div className="container max-w-[1100px] mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {CLOSED_MISSIONS.map((mission, index) => (
                        ...
                        <div key={index} className="bg-white p-8 border border-gray-100 shadow-sm flex flex-col items-center text-center transition-all duration-300 h-[280px] hover:bg-[#f2f2f2] cursor-pointer">
