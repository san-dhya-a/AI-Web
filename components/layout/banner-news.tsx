                ...
                <div className="max-w-[1100px] mx-auto px-6">
                    ...
                    <section className={`relative overflow-hidden ${backgroundImage ? 'h-[180px]' : 'bg-[#f2f2f2] pb-10 pt-4'}`}>
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-center text-left px-8 md:px-12">
                            <h1 className={`text-[36px] md:text-[42px] uppercase italic leading-none tracking-tighter ${acuminCondBlackItalic.className} ${backgroundImage ? 'text-white' : 'text-[#004415]'}`}>
                                {title}
                            </h1>
                            {subtitle && (
                                <p className={`text-[13px] md:text-[14px] font-bold italic mt-2 ${acuminProBold.className} ${backgroundImage ? 'text-white' : 'text-[#004415]'}`}>
                                    {subtitle}
                                </p>
                            )}
                        </div>
