...
export default function Home() {
    ...
    const onSubmit = async (data: RegisterFormData) => {
        try {
            ...
            alert(err.message || "Error during registration. Please check your data and try again.");
        } finally {
    ...
    const onError = (errors: any) => {
        console.error("Validation errors full object:", errors);
        ...
        if (errorEntries.length > 0) {
            ...
            alert("Não foi possível cadastrar. Verifique os campos sinalizados.");
        }
    };
